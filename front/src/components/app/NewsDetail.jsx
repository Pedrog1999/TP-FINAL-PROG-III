    ...
    <>
      ...
      <div className={styles.card}>
        <div className={styles.header}>
          <span className={`${styles.tag} ${styles.tagRed}`}>{news.category?.toUpperCase()}</span>

          {news.image_url ? (
            <div className={styles.image}>
              <img src={news.image_url} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: 'var(--radius)' }} />
            </div>
          ) : (
            <div className={styles.image}>
